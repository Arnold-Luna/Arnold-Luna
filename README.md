# Arnoldo Luna  
Cybersecurity | SOC | Cloud Security | Incident Response | SIEM 

Cybersecurity professional with hands-on experience in detection engineering, log analysis, cloud security, and defensive security workflows.

Focused on building repeatable, documented, real-world simulations that demonstrate SOC readiness.
...
- SIEM Monitoring & Detection Engineering
...
- Wazuh alert detection (Rule 5760)  
- MITRE ATT&CK mapping (T1110 – Brute Force)  
- Automated containment using Fail2Ban  
- Documented findings and defensive validation  

---

## 📂 Technical Portfolio

🔗 Full Project Repository: **[Github](https://github.com/Arnold-Luna/cybersecurity-projects)**
...
*All testing performed in controlled lab environments.*
